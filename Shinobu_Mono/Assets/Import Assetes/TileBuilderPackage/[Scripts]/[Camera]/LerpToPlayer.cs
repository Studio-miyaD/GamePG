...
public class LerpToPlayer : MonoBehaviour {
	...
	private void Awake() {
		...
		//player = FinedObjectsOfType(typeof(Player)) as Player;
	}
	*/
	...
	private void FixedUpdate() {
		...
		*/
		xPositionOfAllPlayers += player.transform.position.x;
		yPositionOfAllPlayers += player.transform.position.y;
		...
		this.transform.position = Vector3.Lerp(this.transform.position, new Vector3(xPositionOfAllPlayers, yPositionOfAllPlayers, this.transform.position.z), 0.1f);
	}
}
